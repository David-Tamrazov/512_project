...
public class SocketResourceManager implements ResourceManager {
    ...
    private RMHashtable dbHashTable;

    public SocketResourceManager(RMHashtable hashTable) {

        dbHashTable = hashTable;
    }
     

    // Reads a data item
    private RMItem readData( int id, String key ) {
        synchronized(dbHashTable) {
            return (RMItem) dbHashTable.get(key);
        }
    }
    ...
    protected RMItem removeData(int id, String key) {
        synchronized(dbHashTable) {
            return (RMItem)dbHashTable.remove(key);
        }
    }
   ...
   // public int queryFlightReservations(int id, int flightNum) throws RemoteException {
   ...
   // }
    ...
    public boolean itinerary(int id, int customerId, Vector flights, String location, boolean bookCars, boolean bookRooms) {
		return false;
    }
...
public boolean itinerary(int id,int customer,Vector flightNumbers, String location, boolean car,boolean room) {
        ...
        return reserveRoom(id, customer, location) && (!car | car && reserveCar(id, customer, location)) && (!room | room && (reserveRoom(id, customer, location)));
    }
*/
